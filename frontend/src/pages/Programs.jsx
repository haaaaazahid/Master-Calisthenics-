      ...
      {loading && (
        <section className="max-w-6xl mx-auto px-6 pb-24 space-y-10">
          ...
          {[1, 2, 3, 4, 5].map((i) => (
            <div
              key={i}
              className="bg-surface rounded-3xl h-[420px] animate-pulse"
            />
          ))}
            ...
            programs.map((p, i) => {
              ...
              return (
                <motion.div
                  ...
                  className={`bg-surface border rounded-3xl overflow-hidden transition-all duration-300 ${
                    p.is_featured
                  ...
                  <div className="p-8 md:p-10">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <h3 className="text-sm uppercase tracking-wider text-text-muted mb-4 font-semibold">
                          What's Included
                        </h3>
                    ...
                    <div className="mt-8 pt-8 border-t border-border flex flex-col sm:flex-row gap-4">
                      ...
                      <a
                        ...
                        className="flex-1"
                      >
                        <button className="w-full border border-border hover:border-orange-500 hover:text-orange-400 transition text-text-muted font-bold py-3.5 rounded-xl">
                          💬 Ask on WhatsApp
                        </button>
                      </a>
      ...
      <section className="max-w-4xl mx-auto px-6 pb-24">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          {[
            ...
            <div
              key={i}
              className="bg-surface border border-border rounded-2xl p-6 flex items-center gap-5 hover:border-orange-500/30 transition"
            >
