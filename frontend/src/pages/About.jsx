          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-[#0B0F19] border border-gray-800 rounded-2xl p-8 hover:border-orange-500/40 transition-all"
              >
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-start">
            <div className="bg-[#111827] border border-gray-800 rounded-3xl p-10">
              ...
              <div className="space-y-5 text-gray-400">
                <div className="flex gap-4">
                  ...
                  <div>
                    <p className="text-white font-medium">PSZ Sports Arena</p>
                ...
                <div className="flex gap-4">
                  <span className="text-2xl">🕐</span>
                  <div>
                    <p className="text-white font-medium">Batch Timings</p>
                ...
                <div className="flex gap-4">
                  <span className="text-2xl">📞</span>
                  <div>
                    <p className="text-white font-medium">+91 84335 99778</p>
            ...
            <div className="space-y-5">
              <div className="bg-[#111827] border border-gray-800 rounded-2xl overflow-hidden h-64">
                <iframe
